...
struct SoftwareMixer {
	...
	void setFrequency(ref Sound sound, uint frequency) @safe nothrow {
		sound.frequency = frequency;
	}

	void setVolume(ref Sound sound, int volume) @safe nothrow {
		sound.volume = cast(short)volume;
	}

	void setPan(ref Sound sound, int pan) @safe nothrow {
		sound.pan = pan;
	}
